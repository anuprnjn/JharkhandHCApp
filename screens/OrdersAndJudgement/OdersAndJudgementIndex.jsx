    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <HeadingText
          ...
          heading="Check the Orders & Judgement"
          subHeading="Use multiple search options to check orders."
        />
...
export default OdersAndJudgementIndex;
